                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    <form action="EditarP.php" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="" class="p-font form-control form-control-lg" placeholder="Usuario" name="username" value ="<?php echo $username; ?>"/>
                            <label class=" p-font form-label" for="form2Example27">Nombre de usuario</label>
                        </div>
                        <!--input correo electronico-->
                        <div class="form-outline mb-4">
                            <input type="email" id="" class="p-font form-control form-control-lg" placeholder="Correo electronico" name="email" value ="<?php echo $email; ?>"/>
                        ...
                        <button type="submit" class="p-font btn btn-block" name="update-actualUser">Editar</button><br>
