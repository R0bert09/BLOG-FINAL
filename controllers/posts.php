...
if (isset($_GET['published']) && isset($_GET['p_id'])) {
    ...
    $_SESSION['message'] = "Estado de publicacion cambiada!";
    $_SESSION['type'] = "success";
    header("location: " . BASE_URL . "/admin/posts/index.php"); 
    exit();
}
...
if (isset($_POST['add-post'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
       ...
       array_push($errors, "Imagen del post requerida");
    }
    if (count($errors) == 0) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if ($result) {
           $_POST['image'] = $image_name;
            ...
            array_push($errors, "Error al cargar la imagen");
        }
    } else {
       array_push($errors, "Imagen de Post requerida");
    }
